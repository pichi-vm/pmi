...
the VMM inspects before launch. See [Overview](overview.md#platform-definition-inversion--goals-2-3-4-and-5)
...
fills these through a separate [`dtbo`](vm.md#dtbo-overlay) overlay, since memory
